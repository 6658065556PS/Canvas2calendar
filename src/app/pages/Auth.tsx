    ...
    <main className="min-h-dvh bg-[#F5F5F5] flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white border border-neutral-200 rounded-xl shadow-sm px-7 py-8">
          <h2 className="text-base font-semibold text-neutral-900 mb-5">Sign in</h2>

          <button
            type="button"
            onClick={signInWithGoogle}
            disabled={loading}
            className="w-full flex items-center justify-center gap-2.5 border border-neutral-300 rounded-lg px-4 py-2.5 text-sm font-medium text-neutral-700 hover:bg-neutral-50 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
